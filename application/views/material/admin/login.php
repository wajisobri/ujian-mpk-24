  ...
  <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/sweetalert2@7.25.6/dist/sweetalert2.all.min.js"></script>
    ...
    function login() {
        ...
        submit({
          ...
          text: "Anda akan login sebagai admin!",
          type: 'warning',
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Login Admin</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-12">
                        <form method="POST" action="<?=base_url('register/authlogin'); ?>" name="form-login" id="form-login">
                            <div class="row">
                                <div class="col-md-12">
