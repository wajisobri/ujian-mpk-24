      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Ujian 1</a>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title">Soal Logika</h4>
                  <p class="card-category">Isi Pertanyaan Disini</p>
                </div>
                <div class="card-body">
                  <form action="<?=base_url('ujian/submit/1'); ?>" name="form-ujian" id="form-ujian" method="POST" >
                  ...
                  foreach ($listExam as $list) { ?>
                    ...
                    <div class="form-check">
                        <label class="form-check-label" style="color: black;">
                            <input onchange="localStorage.setItem('soal_1_<?=$i; ?>', 'a');" class="form-check-input" type="radio" name="soal_<?=$i; ?>" id="soal_<?=$i; ?>" value="a">
                            <?=$list->a; ?>
                            <span class="circle">
                    ...
                    <div class="form-check">
                        <label class="form-check-label" style="color: black;">
                            <input onchange="localStorage.setItem('soal_1_<?=$i; ?>', 'b');" class="form-check-input" type="radio" name="soal_<?=$i; ?>" id="soal_<?=$i; ?>" value="b" >
                            <?=$list->b; ?>
                            <span class="circle">
                                <span class="check"></span>
                            </span>
                    ...
                    <div class="form-check">
                        <label class="form-check-label" style="color: black;">
                            <input onchange="localStorage.setItem('soal_1_<?=$i; ?>', 'c');" class="form-check-input" type="radio" name="soal_<?=$i; ?>" id="soal_<?=$i; ?>" value="c" >
                            <?=$list->c; ?>
                            <span class="circle">
                                <span class="check"></span>
                            </span>
                    ...
                    <div class="form-check">
                        <label class="form-check-label" style="color: black;">
                            <input onchange="localStorage.setItem('soal_1_<?=$i; ?>', 'd');" class="form-check-input" type="radio" name="soal_<?=$i; ?>" id="soal_<?=$i; ?>" value="d" >
                            <?=$list->d; ?>
                            <span class="circle">
                                <span class="check"></span>
                            </span>
              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    foreach($listExam as $exam) {
                        $answer = "<script>document.write(localStorage.getItem('soal_1_".$j."'));</script>";
                        echo $j.". ".$answer."<br />";
                        $j++;
                    }
                    ?>
